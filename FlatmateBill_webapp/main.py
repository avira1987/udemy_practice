...
class BillFormPage(MethodView):
        ...
        def post(self):
            ...
            flatmate2 = Flatmate(name2, days_in_house= days_in_house2)

            return render_template('bill_form_page.html', result =True,
                                                    billform = billform,
                                                    name1 = flatmate1.name, amount1 = 
                                                    flatmate1.pays(the_bill,flatmate2),
                                                    name2 =flatmate2.name, amount2 =
                                                    flatmate2.pays(the_bill, flatmate1)                                                
                                                    )
...
class ResultPage(MethodView):
    ...
    def post(self):
        ...
        return render_template('results.html', name1 = flatmate1.name, amount1 = 
                                                flatmate1.pays(the_bill,flatmate2),
                                                name2 =flatmate2.name, amount2 =
                                                flatmate2.pays(the_bill, flatmate1)                                                
                                                )
...
class BillForm(Form):
    ...
    period = StringField("Bill Period:", default=" Desember 2020")
