...
class CaloriesForm(Form):
    ...
    city = StringField("City: ", default ='Gorgan')
    button = SubmitField('Calculate')

app.add_url_rule('/', view_func= HomePage.as_view('home_page'))
app.add_url_rule('/calories_form_page', view_func= CaloriesFormPage.as_view('colories_form_page'))
